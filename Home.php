    ...
    <main class="bg-light">
        <div class="container-sm bg-light">
            <div class="text">
                ...
                <h6 style="margin-bottom:35px;">Từ những khu nghỉ dưỡng thanh bình đến những căn hộ sang trọng hiện đại
                </h6>
            </div>
                ...
                <div class="content_item col-grid-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card">
                        <div class="img_item pe-3">
                            <a href="./hotel_detail.php">
                            <img src="admin/hotel/photo/<?php echo $row['anh'];?>" alt="">
                            </a>
                        </div>

                        <div class="card-body">
                            <b class="card_titler"><?php echo $row['tenkhachsan'];?></b>
                            <form action="">
                                <i class="fas fa-map-marker-alt"></i>
                              <h4><?php echo $row['diachi'];?></h4>


                            </form>
                            <h7 class="card-text">Giá mỗi đêm</h7>
                            <h6 style="color: red;"><?php echo $row['gia']?> </h6>
                        </div>
                    </div>
                </div>
                <?php
    ...
    <div class="container-sm">
        <div class="row">
            <div class="col-md-6 right">
                ...
                <p>Những mô hình vườn cây trải nghiệm không chỉ mang lại nguồn thu nhập cho hộ gia đình mà nó còn góp
                    phần vào
                    việc phát triển ngành du lịch của địa phương. Nắm bắt được xu hướng này thì vườn cam Mộc Châu cũng
                    đã xuất
                    hiện và thu hút rất đông lượng du khách hàng năm.... </p>
                <a href="https://danatravel.vn/thong-tin-du-lich/bo-tui-10-dia-diem-check-in-cuc-dep-tai-moc-chau.html">Xem
                    thêm</a>
            </div>
            ...
            <div class="col-md-6 left">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h3>Mới lạ địa điểm check in vườn cam Mộc Châu đẹp ‘hút hồn’ team mê sống ảo</h3>
                        <p>Những mô hình vườn cây trải nghiệm không chỉ mang lại nguồn thu nhập cho hộ gia đình mà nó
                            còn góp phần
                            vào việc phát triển ngành du lịch của địa phương. Nắm bắt được xu hướng này thì vườn cam Mộc
                            Châu cũng
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>🎅Với tiết trời se lạnh và khung cảnh lãng mạn, Đà Lạt là nơi hẹn hò lý tưởng cho các cặp đôi
                            vào dịp lễ
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>Trải nghiệm vẻ đẹp bình yên mang đến những phút giây thật sự thư giãn dành riêng cho bạn
                            trong tiết trời
